...
const ShopHero = () => {
    return (
        <div className="relative w-full h-[400px] md:h-[500px] overflow-hidden flex items-center bg-gray-100">
            {/* Background Image */}
            ...
            <div className="max-w-7xl mx-auto px-6 relative z-10 w-full flex justify-end">
                ...
                <div className="w-full md:w-1/2 lg:w-[45%] text-left md:text-left text-gray-900 bg-white/80 md:bg-transparent p-6 md:p-0 rounded-2xl md:rounded-none backdrop-blur-sm md:backdrop-blur-none">
                    <h1 className="text-4xl md:text-5xl lg:text-6xl font-black mb-4 leading-tight tracking-tight uppercase text-gray-900">
                    ...
                    <button className="group relative inline-flex items-center gap-3 px-8 py-3 bg-[#02D5E0] text-white font-bold text-lg shadow-lg hover:bg-cyan-400 transition-all duration-300">
